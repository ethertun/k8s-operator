...
//+kubebuilder:rbac:groups=net.ethertun.com,resources=terminals,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=net.ethertun.com,resources=terminals/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=net.ethertun.com,resources=terminals/finalizers,verbs=update
